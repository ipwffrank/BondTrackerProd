...
const PrivacyPolicy = () => (
  <>
    ...
    <p>ZHOOZH is the data controller responsible for the personal data collected through the Platform. For any enquiries regarding this Privacy Policy or your personal data, please contact our Data Protection Officer at the contact details provided in Section 15 of this Policy.</p>
    ...
    <p>The Platform may contain links to third-party websites or services that are not operated or controlled by ZHOOZH. This Privacy Policy does not apply to such third-party services. We encourage you to review the privacy policies of any third-party websites you visit. ZHOOZH is not responsible for the content, privacy practices, or security of any third-party websites.</p>
    ...
    <p><strong>Data Protection Officer</strong><br />ZHOOZH PTE. LTD.<br />Email: <a href="mailto:info@axle-finance.com">info@axle-finance.com</a><br />Website: axle-finance.com</p>
...
const TermsOfService = () => (
  <>
    ...
    <p>By accessing, browsing, or using the Axle platform at axle-finance.com (the "Platform"), you ("User", "you", "your") acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms"). The Platform is owned and operated by ZHOOZH PTE. LTD. ("ZHOOZH", "we", "us", "our"), a company registered in Singapore.</p>
    <p>If you do not agree to these Terms, you must not access or use the Platform.</p>
    <p>ZHOOZH reserves the right to modify, amend, or update these Terms at any time. Changes will be effective upon posting to the Platform. Your continued use of the Platform after any modifications constitutes acceptance of the revised Terms.</p>
    ...
    <p>ZHOOZH provides the Axle platform, a cloud-based solution for bond trading activity tracking, client relationship management, pipeline management, analytics, and AI-powered transcript analysis for financial services professionals (the "Services"). The Platform is designed as a productivity and information management tool for use by authorised institutional users.</p>
    ...
    <p>You are responsible for maintaining the confidentiality of your login credentials and for all activities conducted under your account. You agree to notify ZHOOZH immediately of any unauthorised use of your account or any other breach of security. ZHOOZH shall not be liable for any loss or damage arising from your failure to protect your account credentials.</p>

    <h3>4.3 Account Termination</h3>
    <p>ZHOOZH reserves the right to suspend or terminate your account at any time, with or without notice, if we reasonably believe that you have violated these Terms, engaged in fraudulent or unlawful activity, or if your continued access poses a risk to the Platform or other users.</p>
    ...
    <ul>
      ...
      <li>ZHOOZH does not guarantee the accuracy, completeness, or reliability of any AI-generated content;</li>
    ...
    <p>The Platform may contain links to third-party websites, services, or resources that are not owned or controlled by ZHOOZH. We do not endorse, monitor, or assume any responsibility for the content, privacy policies, practices, or availability of any third-party services. Your interaction with any third-party service is governed by that third party's own terms and policies, and is at your sole risk.</p>
    ...
    <p>ZHOOZH reserves the right to modify, suspend, or discontinue the Platform or any part thereof, temporarily or permanently, at any time and without prior notice. ZHOOZH shall not be liable to you or any third party for any modification, suspension, or discontinuance of the Platform.</p>
    ...
    <p>These Terms, together with the Privacy Policy and any other legal notices or agreements published by ZHOOZH on the Platform, constitute the entire agreement between you and ZHOOZH regarding your use of the Platform and supersede all prior or contemporaneous agreements, communications, and proposals, whether oral or written.</p>

    <h2>17. Waiver</h2>
    <p>The failure of ZHOOZH to exercise or enforce any right or provision of these Terms shall not constitute a waiver of such right or provision. Any waiver of any provision of these Terms will be effective only if in writing and signed by ZHOOZH.</p>
    ...
    <p>ZHOOZH PTE. LTD.<br />Email: <a href="mailto:info@axle-finance.com">info@axle-finance.com</a><br />Website: axle-finance.com</p>
...
const Disclaimer = () => (
  <>
    ...
    <ul>
      ...
      <li>ZHOOZH does not guarantee the accuracy, completeness, reliability, or timeliness of any AI-generated output;</li>
    ...
    <p>To the fullest extent permitted by applicable law, ZHOOZH, its directors, officers, employees, agents, and affiliates shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, revenue, data, goodwill, or other intangible losses, resulting from:</p>
    <ul>
    ...
    <h2>11. Amendments</h2>
    <p>ZHOOZH reserves the right to modify, update, or revise this Disclaimer at any time without prior notice. Continued use of the Platform following any changes constitutes acceptance of the revised terms. Users are encouraged to review this Disclaimer periodically.</p>
