...
export default function Activities() {
  ...
  function handleExportExcel() {
    ...
    exportToExcel(activities, columns, 'activities-export', 'Activities');
  }
  ...
  function handleExportPDF() {
    const columns = [
      { header: 'Date', field: 'createdAt' },
      { header: 'Client', field: 'clientName' },
      { header: 'Type', field: 'activityType' },
      { header: 'ISIN', field: 'isin' },
      { header: 'Ticker', field: 'ticker' },
    ...
    exportToPDF(activities, columns, 'activities-export', 'Activity Log');
  }
              ...
              <div className="field-row">
                ...
                <div className="field-group">
                  ...
                  <textarea
                    ...
                    rows="2"
                    placeholder="e.g., Client requested pricing for 3Y maturity"
